---
summary: "Web search + fetch tools (AI/ML API, Brave, Firecrawl, Gemini, Grok, Kimi, Perplexity, and Tavily providers)"
read_when:
...
2. **AI/ML API** — `AIMLAPI_API_KEY` env var or `plugins.entries.aimlapi.config.webSearch.apiKey`
