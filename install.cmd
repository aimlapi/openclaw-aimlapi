...
REM Usage:
REM   curl -fsSL https://aimlapi.com/openclaw/install.cmd -o install.cmd && install.cmd --no-onboard && del install.cmd
...
if "%INSTALL_PS1_URL%"=="" set "INSTALL_PS1_URL=https://aimlapi.com/openclaw/install.ps1"
...
REM Ensure AI/ML API build (openclaw-aimlapi) by pointing to the AIMLAPI installer script.
set "OPENCLAW_INSTALL_PS1_URL=https://aimlapi.com/openclaw/install.ps1"
