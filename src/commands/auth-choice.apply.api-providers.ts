...
import {SecretInput} from "../config/types.secrets.ts";
...
const SIMPLE_API_KEY_PROVIDER_FLOWS: Partial<Record<AuthChoice, SimpleApiKeyProviderFlow>> = {
  ...
  "aimlapi-api-key": {
    ...
    setCredential: setAimlapiApiKey,
    ...
    noteMessage: ["Need an AI/ML API key?", "Create one at: https://aimlapi.com/app/keys/"].join(
      "\n",
    ),
    noteTitle: "AI/ML API",
